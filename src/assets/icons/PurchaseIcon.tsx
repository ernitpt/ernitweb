  ...
  return (
    <Svg width={width} height={height} viewBox="0 0 18 18" fill="none">
      ...
      <Path
        ...
        stroke="url(#purchase_grad2)"
        strokeWidth={2}
        strokeLinecap="round"
      />
      <Defs>
        <LinearGradient id="purchase_grad1" x1="9" y1="17" x2="9" y2="6" gradientUnits="userSpaceOnUse">
          <Stop stopColor="#6316A5" />
          <Stop offset="1" stopColor="#2577CA" />
        </LinearGradient>
        <LinearGradient id="purchase_grad2" x1="9" y1="8" x2="9" y2="1" gradientUnits="userSpaceOnUse">
          <Stop stopColor="#6316A5" />
          <Stop offset="1" stopColor="#2577CA" />
        </LinearGradient>
      </Defs>
